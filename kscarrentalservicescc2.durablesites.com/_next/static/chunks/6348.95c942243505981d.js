            ...
            var n, t = r(85893),
                ...
                m = function(e) {
                    var o = e.latLng,
                        ...
                        v = void 0 === f ? 10 : f,
                        x = (0, a.useRef)(null),
                        b = (0, a.useRef)("map-".concat((new Date).getTime(), "-").concat(Math.floor(1e3 * Math.random()))),
                        h = (0, a.useRef)(null);

                    function k() {
                        var e = window.L;
                        if (null === e || void 0 === e ? void 0 : e.mapbox) {
                            x.current && x.current.remove(), h.current && h.current.remove(), e.mapbox.accessToken = "pk.eyJ1IjoiZHVyYWJsZSIsImEiOiJjbGJjOHV1bHUwcjM5M3huOHdoZXdkdDRsIn0.geBkTZ4KBXWb669GQBr8rw";
                            ...
                            var a = e.marker([r.lat, r.lng], {
                                icon: e.mapbox.marker.icon({
                                    "marker-color": u
                                })
                            });
                            a.addTo(o), x.current = a, o.panTo([r.lat, r.lng]), h.current = o
                    ...
                    return (0, a.useEffect)((function() {
                        return n = setTimeout((function() {
                            ...
                            function() {
                                n && clearTimeout(n), x.current && x.current.remove(), h.current && h.current.remove()
                            }
                    }), []), (0, t.jsxs)(t.Fragment, {
                        children: [(0, t.jsx)(i(), {
